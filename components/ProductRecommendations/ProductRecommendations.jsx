    ...
    <section className="products-section">
      <div className="products-container">
        ...
        <div className="products-wrapper">
          <button className="nav-arrow nav-arrow-left" onClick={scrollLeft} disabled={scrollPosition <= 0}>
              ...
              {products.map((product) => (
                <div key={product.id} className="product-card">
                  <div className="product-image-container">
                    ...
                    {product.badge && <div className={`product-badge ${product.badgeColor}`}>{product.badge}</div>}
                  </div>
          ...
          <button className="nav-arrow nav-arrow-right" onClick={scrollRight} disabled={scrollPosition >= maxScroll}>
            <svg className="arrow-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="scroll-indicator-wrapper">
          <button className="scroll-nav-btn scroll-nav-left" onClick={scrollLeft} disabled={scrollPosition <= 0}>
            <svg className="scroll-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          </button>
          ...
          <div className="scroll-indicator" onClick={handleIndicatorClick}>
            <div className="scroll-track">
              <div className="scroll-thumb" style={{ left: `${scrollPercentage}%` }}></div>
            </div>
          </div>
